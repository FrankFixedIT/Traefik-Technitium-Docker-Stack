...
12. Best practice
- Once access to the Technitium portal via FQDN is available (A/CNAME records in your newly creataed zone on Technitium (I hope, or why are even doing this?)), change line 53 in docker-compose.yml to remove direct access via IP. (IPTables <a href=https://github.com/FrankFixedIT/IPTalbesSetupDebian> are cool too.)
```
      - "5380/tcp"
``` 
- Commit the change
